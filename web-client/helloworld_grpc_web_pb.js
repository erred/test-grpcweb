...
proto.helloworld.GreeterPromiseClient = function(hostname, credentials, options) {
   ...
   */
  this.delegateClient_ = new proto.helloworld.GreeterClient(hostname, credentials, options);
};
...
proto.helloworld.GreeterPromiseClient.prototype.sayHello = function(request, metadata) {
  return new Promise((resolve, reject) => {
    this.delegateClient_.sayHello(request, metadata, (error, response) => {
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterClient.prototype.sayRepeatHello = function(request, metadata) {
  console.log("sayrepeathello called");
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterPromiseClient.prototype.sayRepeatHello = function(request, metadata) {
  return this.delegateClient_.client_.serverStreaming(
    this.delegateClient_.hostname_ + "/helloworld.Greeter/SayRepeatHello",
    request,
    metadata,
    methodInfo_Greeter_SayRepeatHello
  );
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterClient.prototype.sayHelloAfterDelay = function(request, metadata, callback) {
  return this.client_.rpcCall(
    this.hostname_ + "/helloworld.Greeter/SayHelloAfterDelay",
    request,
    metadata,
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterPromiseClient.prototype.sayHelloAfterDelay = function(request, metadata) {
  return new Promise((resolve, reject) => {
    this.delegateClient_.sayHelloAfterDelay(request, metadata, (error, response) => {
      error ? reject(error) : resolve(response);
    });
  });
};
